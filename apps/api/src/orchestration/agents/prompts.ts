...
Para consultas sobre los antecedentes, sanciones o historial de un administrado concreto (SIN pedir informe), planifica DOS tareas: (1) dominio "oefa_data" operación "search" — los registros oficiales; (2) dominio "oefa_docs" operación "search" — la normativa, resoluciones y guías relevantes del corpus documental. Incluye la consulta original del usuario en inputs.query de AMBAS tareas.
